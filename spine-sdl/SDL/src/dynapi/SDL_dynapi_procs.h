...
SDL_DYNAPI_PROC(int, SDL_RenderCopySpine, (SDL_Renderer * a, SDL_Texture * b, unsigned int c, unsigned int d, unsigned int e, unsigned int f, const char* g), (a, b, c, d, e, f, g), return)
