...
/**
*  \brief Get driver data of a renderer.
*/
extern DECLSPEC void* SDLCALL SDL_GetRenderDriverData(SDL_Renderer* renderer);
extern DECLSPEC void* SDLCALL SDL_GetTextureDriverData(SDL_Texture* texture);
/**
