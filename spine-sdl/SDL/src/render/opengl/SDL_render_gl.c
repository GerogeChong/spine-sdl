...
static int
GL_RenderCopySpine(SDL_Renderer * renderer, SDL_Texture * texture,unsigned int mode,unsigned int VertexSize,unsigned int firstVertex,unsigned int vertexCount,const char* src_data);
